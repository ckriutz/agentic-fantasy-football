...
public class FantasyAgent
{
    ...
    public async Task<AIAgent> CreateFantasyAgentAsync(string agentId, string modelName)
    {
        ...
        - Give your team a creative name. It can be fantasy football related, but it doesn't have to be, it can be sports related, or anything that inspires you. Save this team name in your bootstrap file and your agent profile.
        ...
        _agent = new ChatClient(modelName, new ApiKeyCredential(apiKey),
            ...
            .AsIChatClient()
            .AsAIAgent(name: "fantasy-agent-" + agentId, instructions: agentInstructions,
            tools:
            [
